...
pub mod path_convertor {
    ...
    use crate::{VALUES_TABLE_INDEX_PREFIX, VALUES_TABLE_NAME};

    use super::{
        ast_views::{
            CreateIndexStatementViewMutable, CreateTableStatementViewMutable,
            DropStatementViewMutable, InsertStatementViewMutable, SetOperationViewMutable,
    ...
    impl SqlAstTraverser for PathConvertor {
        ...
        fn post_visit_create_table(
            ...
            let db_reference =
                convert_path_to_database(create_table.name, &mut self.database_names)?;
